...
i = 0
for in_features in IN_FEATURES:

    i += 1
    print("Test [%d][%s]" % (i,  in_features))
    ...
    cfg.MODEL.SEM_SEG_HEAD.IN_FEATURES = in_features
    ...
    evaluator = COCOEvaluator(VAL_NAME, cfg, False, output_dir="./output_%d/" % i)
